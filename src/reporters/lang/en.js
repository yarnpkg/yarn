...
const messages = {
  ...
  lockfileOutdated: 'Outdated lockfile. Please run `yarn` and try again.',
  ...
  linkDisusingMessage: 'You will need to run `yarn add --force <package-name>` to re-install the package that was linked.',
  ...
  noRequiredLockfile: 'No lockfile in this directory. Run `yarn` to generate one.',
