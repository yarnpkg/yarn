...
test("JSONReporter.step", async (t) => {
  t.deepEqual(await getJSONBuff((r) => r.step(1, 5, "foobar")), {
    stderr: "",
...
test("JSONReporter.footer", async (t) => {
  t.deepEqual(await getJSONBuff((r) => r.footer()), {
    stderr: "",
...
test("JSONReporter.log", async (t) => {
  t.deepEqual(await getJSONBuff((r) => r.log("foobar")), {
    stderr: "",
...
test("JSONReporter.command", async (t) => {
  t.deepEqual(await getJSONBuff((r) => r.command("foobar")), {
    stderr: "",
...
test("JSONReporter.success", async (t) => {
  t.deepEqual(await getJSONBuff((r) => r.success("foobar")), {
    stderr: "",
...
test("JSONReporter.error", async (t) => {
  t.deepEqual(await getJSONBuff((r) => r.error("foobar")), {
...
test("JSONReporter.warn", async (t) => {
  t.deepEqual(await getJSONBuff((r) => r.warn("foobar")), {
...
test("JSONReporter.info", async (t) => {
  t.deepEqual(await getJSONBuff((r) => r.info("foobar")), {
    stderr: "",
...
test("JSONReporter.activity", async (t) => {
  t.deepEqual(await getJSONBuff(async function (r) {
