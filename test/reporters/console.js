...
test('ConsoleReporter.step', async (t) => {
  t.deepEqual(await getConsoleBuff((r) => {
    r.step(1, 5, 'foboar');
  }), {
    stderr: '',
...
test('ProgressBar', (t) => {
  ...
  bar.render();
  t.deepEqual(data, '\u001b[2K\u001b[1G░░ 0/2');

  bar.tick();
  bar.render();
  t.deepEqual(data, '\u001b[2K\u001b[1G░░ 0/2\u001b[2K\u001b[1G█░ 1/2');

  bar.tick();
  bar.render();
  t.deepEqual(data, '\u001b[2K\u001b[1G░░ 0/2\u001b[2K\u001b[1G█░ 1/2\u001b[2K\u001b[1G\u001b[2K\u001b[1G██ 2/2');
});
...
test('Spinner', (t) => {
  ...
  spinner.start();
  t.deepEqual(data, '\u001b[2K\u001b[1G⠁ ');

  spinner.setText('foo');
  spinner.render();
  t.deepEqual(data, '\u001b[2K\u001b[1G⠁ \u001b[2K\u001b[1G⠂ foo');

  spinner.setText('bar');
  spinner.render();
  t.deepEqual(data, '\u001b[2K\u001b[1G⠁ \u001b[2K\u001b[1G⠂ foo\u001b[2K\u001b[1G⠄ bar');

  spinner.stop();
  t.deepEqual(data, '\u001b[2K\u001b[1G⠁ \u001b[2K\u001b[1G⠂ foo\u001b[2K\u001b[1G⠄ bar\u001b[2K\u001b[1G');
});
