...
test.skip('Self-update should download a release and symlink it as "current"', async (): Promise<void> => {
...
test.skip('Self-update should work from self-updated location', async (): Promise<void> => {
  return run(async (reporter, config) => {
