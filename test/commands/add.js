...
import {runInstall, getPackageVersion, createLockfile, explodeLockfile, run as buildRun} from './_install.js';
...
test('[network] install --save with new dependency should be deterministic 3', async (t): Promise<void> => {
...
test.skip('[network] install --save with new dependency should be deterministic 2', async (): Promise<void> => {
