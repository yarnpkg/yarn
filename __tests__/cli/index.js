...
test('setAliasCmd should rewrite "yarn a" to "yarn add"', () => {
  expect(setAliasCmd('a', aliases)).toBe('add');
});
...
test('setAliasCmd should rewrite "yarn v" to "yarn info"', () => {
  expect(setAliasCmd('v', aliases)).toBe('info');
});