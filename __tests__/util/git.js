...
test('npmUrlToGitUrl', () => {
  expect(
    Git.npmUrlToGitUrl('git+https://github.com/npm-opam/ocamlfind.git'),
  ).toEqual({
    protocol: 'https:',
    hostname: 'github.com',
  ...
  expect(
    Git.npmUrlToGitUrl('https://github.com/npm-opam/ocamlfind.git'),
  ).toEqual({
    protocol: 'https:',
    hostname: 'github.com',
    repository: 'https://github.com/npm-opam/ocamlfind.git',
  ...
  expect(
    Git.npmUrlToGitUrl('git://github.com/npm-opam/ocamlfind.git'),
  ).toEqual({
    protocol: 'git:',
    hostname: 'github.com',
  ...
  expect(
    Git.npmUrlToGitUrl(
      'git+ssh://git@gitlab.mydomain.tld:10202/project-name/my-package.git',
    ),
  ).toEqual({
    protocol: 'ssh:',
  ...
  expect(
    Git.npmUrlToGitUrl('git+ssh://git@github.com/npm-opam/ocamlfind.git'),
  ).toEqual({
    protocol: 'ssh:',
    hostname: 'github.com',
  ...
  expect(
    Git.npmUrlToGitUrl('git+ssh://scp-host-nickname:npm-opam/ocamlfind.git'),
  ).toEqual({
    protocol: 'ssh:',
  ...
  expect(
    Git.npmUrlToGitUrl(
      'git+ssh://user@scp-host-nickname:npm-opam/ocamlfind.git',
    ),
  ).toEqual({
    protocol: 'ssh:',
    hostname: 'scp-host-nickname',
...
test('isCommitHash', () => {
  expect(
    Git.isCommitHash('ca82a6dff817ec66f44312307202690a93763949'),
  ).toBeTruthy();
...
test('secureGitUrl', async function(): Promise<void> {
  ...
  try {
    await Git.secureGitUrl(
      Git.npmUrlToGitUrl('http://fake-fake-fake-fake.com/123.git'),
      '',
      reporter,
    );
  } catch (e) {
  ...
  let gitURL = await Git.secureGitUrl(
    Git.npmUrlToGitUrl('http://github.com/yarnpkg/yarn.git'),
    '',
    reporter,
  );
  expect(gitURL.repository).toEqual('https://github.com/yarnpkg/yarn.git');

  gitURL = await Git.secureGitUrl(
    Git.npmUrlToGitUrl('https://github.com/yarnpkg/yarn.git'),
    '',
    reporter,
  );
  expect(gitURL.repository).toEqual('https://github.com/yarnpkg/yarn.git');
  ...
  gitURL = await Git.secureGitUrl(
    Git.npmUrlToGitUrl('git://github.com/yarnpkg/yarn.git'),
    '',
    reporter,
  );
  expect(gitURL.repository).toEqual('https://github.com/yarnpkg/yarn.git');
...
test('parseRefs', () => {
  expect(
    Git.parseRefs(`64b2c0cee9e829f73c5ad32b8cc8cb6f3bec65bb refs/tags/v4.2.2`),
  ).toMatchObject({
